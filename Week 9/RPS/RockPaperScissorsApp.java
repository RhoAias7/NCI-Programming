 ...
 */
 ...
 public class RockPaperScissorsApp{
	 public static void main(String args[]){
		...
		if(player2>1){
			JOptionPane.showMessageDialog(null, "You have lost all 3 rounds");
			}
		else if(player2<1){
			JOptionPane.showMessageDialog(null, "You have won all the rounds");
			}
		else{
			JOptionPane.showMessageDialog(null, "You have drawn all 3 rounds");
			}
